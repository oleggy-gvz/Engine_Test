...
void MainWindow::showEvent(QShowEvent* event)
{
    ...
    //shared_ptr<Interpolation> inter(new LinearInterpolation({0, 75, 150, 200, 250, 300}, {20, 75, 100, 105, 75, 0}));
    shared_ptr<Interpolation> inter(new CubicSplineInterpolation({0, 75, 150, 200, 250, 300}, {20, 75, 100, 105, 75, 0}));
